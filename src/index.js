...
WEST-OF-HOUSE
contains: door,
small mailbox" shape=box style=filled]
...
MOUNTAINS
contains: mountain range" shape=box style=filled]
...
UP-A-TREE
contains: bird's nest" shape=box style=filled]
	"UP-A-TREE" -> PATH [label=DOWN]
	"GRATING-CLEARING" [label="Clearing
GRATING-CLEARING
contains: pile of leaves" shape=box style=filled]
...
KITCHEN
contains: kitchen table" shape=box style=filled]
...
TROLL-ROOM
contains: troll" shape=box style=filled]
...
GALLERY
contains: painting" shape=box style=filled]
	GALLERY -> "EAST-OF-CHASM" [label=WEST]
	GALLERY -> STUDIO [label=NORTH]
	STUDIO [label="Studio
STUDIO
contains: ZORK owner's manual" shape=box style=filled]
...
rusty knife,
skeleton key" shape=box style=filled]
...
CYCLOPS-ROOM
contains: cyclops" shape=box style=filled]
...
TREASURE-ROOM
contains: chalice" shape=box style=filled]
...
RESERVOIR
contains: trunk of jewels" shape=box style=filled]
...
RESERVOIR-NORTH
contains: hand-held air pump" shape=box style=filled]
...
MIRROR-ROOM-1
contains: mirror" shape=box style=filled]
...
ATLANTIS-ROOM
contains: crystal trident" shape=box style=filled]
...
ROUND-ROOM
contains: thief" shape=box style=filled]
...
LOUD-ROOM
contains: platinum bar" shape=box style=filled]
...
ENTRANCE-TO-HADES
contains: number of ghosts" shape=box style=filled]
...
LAND-OF-LIVING-DEAD
contains: crystal skull" shape=box style=filled]
...
SOUTH-TEMPLE
contains: altar,
pair of candles" shape=box style=filled]
...
green bubble,
dam,
control panel" shape=box style=filled]
...
DAM-LOBBY
contains: matchbook,
tour guidebook" shape=box style=filled]
...
RIVER-4
contains: red buoy" shape=box style=filled]
...
END-OF-RAINBOW
contains: pot of gold" shape=box style=filled]
...
GAS-ROOM
contains: sapphire-encrusted bracelet" shape=box style=filled]
...
DEAD-END-5
contains: small pile of coal" shape=box style=filled]
	"DEAD-END-5" -> "LADDER-BOTTOM" [label=NORTH]
	"TIMBER-ROOM" [label="Timber Room
TIMBER-ROOM
contains: broken timber" shape=box style=filled]
